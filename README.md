...
## Project Structure
    ...
    ├── modules                        # Modules app
    ├── sportybet_adder_35653  # Django project configurations
...
1. Clone this repo and `cd sportybet_adder_35653`
...
2. Clone this repo and `cd sportybet_adder_35653`
...
Admin Panel can be accessed through http://localhost:8000/admin/. If you are the Project Owner, admin credentials can be generated from App > Settings on App Dashboard. If not, please request your PM or Project Owner to generate admin credentials and share with you.
